...
export const SECRET_DETECTORS: PatternDetector[] = [
  ...
  },
  {
    ...
    severity: "critical",
    confidence: "high",
    message: "A GitHub fine-grained personal access token was detected.",
  ...
  },
  {
    ...
    severity: "critical",
    confidence: "high",
    message: "A Stripe API key was detected.",
  ...
  },
  {
    ...
    severity: "critical",
    confidence: "high",
    message: "A SendGrid API key was detected.",
  ...
  },
  {
    ...
    severity: "critical",
    confidence: "high",
    message: "An npm access token was detected.",
  ...
  },
  {
    ...
    severity: "high",
    confidence: "medium",
    message: "A Twilio Account SID was detected.",
  ...
  },
  {
    ...
    severity: "high",
    confidence: "high",
    message: "A Slack incoming-webhook URL was detected.",
    pattern: /\bhttps:\/\/hooks\.slack\.com\/services\/[A-Za-z0-9/_-]{20,}\b/g,
  },
  {
    id: "google_api_key",
    type: "api_key",
  ...
  },
  {
    ...
    severity: "high",
    confidence: "medium",
    message: "An Authorization bearer token was detected.",
